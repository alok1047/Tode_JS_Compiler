...
public class Minifier implements Expr.Visitor<String>, Stmt.Visitor<String> {
    ...
    public String visitDestructuredVarDeclarationStmt(Stmt.DestructuredVarDeclaration stmt) {
        StringBuilder sb = new StringBuilder();
        sb.append(stmt.keyword.getLexeme()).append(" ").append(stmt.pattern.accept(this));
        if (stmt.initializer != null) {
            sb.append("=").append(stmt.initializer.accept(this));
        }
        sb.append(";");
    ...
    public String visitForInStmt(Stmt.ForIn stmt) {
        ...
        return "for(" + init + " in " + stmt.object.accept(this) + ")" + stmt.body.accept(this);
    }
    ...
    public String visitForOfStmt(Stmt.ForOf stmt) {
        ...
        return "for(" + init + " of " + stmt.iterable.accept(this) + ")" + stmt.body.accept(this);
    }
